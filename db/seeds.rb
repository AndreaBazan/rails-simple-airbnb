...
Flat.create!(
  name: 'Romantic, Lakeside Home with Views of Lake',
  address: 'Menaggio 33, lombardy, Italy',
  description: 'A beautiful leafy neighbourhood on the shores of Lake Como, within walking distance of the centre of Menaggio, with great stores, restaurants and a lido',
  price_per_night: 560,
  number_of_guests: 4
)